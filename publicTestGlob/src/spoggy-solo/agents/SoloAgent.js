...
SoloAgent.prototype = Object.create(eve.Agent.prototype);
SoloAgent.prototype.constructor = SoloAgent;

/**
* Send a greeting to an agent
* @param {String} to
*/
SoloAgent.prototype.sayHello = function(to) {
  this.send(to, 'Hello ' + to + '!');
};

/**
* Handle incoming greetings. This overloads the default receive,
* so we can't use SoloAgent.on(pattern, listener) anymore
* @param {String} from     Id of the sender
* @param {*} message       Received message, a JSON object (often a string)
*/
SoloAgent.prototype.receive = function(from, message) {
